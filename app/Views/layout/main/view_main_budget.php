...
<body>
    <div class="grid grid-cols-12 min-h-screen">
        ...
        <div class=" col-span-12 md:col-span-9 min-h-screen">
            <div class="bg-[#ffffff]">
                <?= $this->include('layout/header_budget') ?>
            </div>
        ...
        <div class="modal-box">
            ...
            <form action="">
                <div class="grid grid-cols-12 gap-3">
                    ...
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                            <legend class="fieldset-legend">Nama Budget</legend>
                            <input type="text" class="input w-full" placeholder="Catatan Transaksi" />
                        </fieldset>
                    </div>
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                            <legend class="fieldset-legend">Nominal</legend>
                            <input type="number" class="input w-full" placeholder="Masukkan Nominal Budget" />
                        </fieldset>
                    </div>
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                            <legend class="fieldset-legend">Target Tercapai</legend>
