...
<?= $this->section('content') ?>
    ...
    <dialog id="modal_dompet" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
                ...
                <div class="grid grid-cols-12 gap-3">
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                            ...
                            <input type="text" name="nama_dompet" class="input w-full" placeholder="Masukkan Nama Dompet" required />
                        </fieldset>
                    </div>
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                    ...
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                            ...
                            <input type="number" name="saldo" class="input w-full" placeholder="Masukkan Saldo" />
                        </fieldset>
                    </div>
                </div>
            </form>
            ...
            <form method="dialog">
                ...
                <button type="submit" class="btn bg-primary-500 text-white" form="dompetForm">Tambah</button>
            </form>
            </div>
        </div>
    </dialog>
    <dialog id="modal_edit_dompet" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box">
            ...
            <form id="editDompetForm" action="<?= base_url('/user/dompet/update') ?>" method="post">
                ...
                <div class="grid grid-cols-12 gap-3">
                    ...
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                            <legend class="fieldset-legend">Nama Dompet</legend>
                            <input type="text" class="input w-full" name="nama_dompet" id="editNamaDompet" placeholder="Masukkan Nama Dompet" />
                        </fieldset>
                    </div>
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                    ...
                    <div class="col-span-12">
                        <fieldset class="fieldset">
                            <legend class="fieldset-legend">Saldo</legend>
                            <input type="number" name="saldo" class="input w-full" id="editSaldo" placeholder="Masukkan Saldo" disabled />
                        </fieldset>
                    </div>
                </div>
            </form>
            ...
            <form method="dialog">
                <!-- if there is a button in form, it will close the modal -->
                <button class="btn">Close</button>
                <button type="submit" class="btn bg-primary-500 text-white" form="editDompetForm">Update</button>
            </form>
            </div>
        </div>
    </dialog>
    <div class="ringkasan font-semibold p-8">
        ...
        <div id="page-content">
            <div class="grid grid-cols-12 gap-5">
                <?php if (empty($dompet)) : ?>
                    <div class="col-span-12 sm:col-span-6 bg-white rounded-xl p-4 border border-shaded-white">
                        ...
                        <div class="col-span-12 sm:col-span-6 bg-white rounded-xl py-6 px-8 border border-shaded-white">
                            <div class="flex flex-row items-center justify-between">
                                <div class="flex flex-col">
                                    ...
                                    <p class="mt-2 text-2xl"><?= esc($d['nama_dompet']) ?></p>
                                    <p class="text-sm text-pale-gray my-2">Indonesian Rupiah (IDR)</p>
                                    <p class="text-3xl text-primary-500 font-black"><?= rupiah($d['saldo']) ?></p>
                                </div>
